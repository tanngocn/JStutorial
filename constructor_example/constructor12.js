...
var player2 = new Player("zseoz", 150);
var player3 = new Player("zeus", 1150);
player1.place = library;
player1.addItem("a rusty key");
player1.addItem("The Sword of Doom");
player2.addItem("iron spear");
player2.addItem("legeand spear");
player2.place=library;
player2.showInfo("=");
player3.addItem("thunder sword");
player3.addItem("justice spear");
player3.place=library;
player3.dropItem(player3.items);
player3.showInfo("=");
