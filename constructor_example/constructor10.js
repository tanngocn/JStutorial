...
var Place = function (title, description) {
    ...
    this.removeItem=function(itemName){
           this.items.splice(itemName.indexOf,1);
    }
};
...
var library1 = new Place(
    "Dungeon 1 ",
    "You are in a dungeon1."
);

library.addItem("a rusty key");
library1.addItem("a key dungeon2");
library1.addItem("spear");
library1.addItem("ironpipe");
library1.addItem("lightspear");
console.log(library1.items.indexOf("spear")+1);
library1.removeItem("spear");
